				...
				<ul className="flex items-center">
					...
					<li className="mx-4">
						<a
							id="btonBantuan"
							className={`bton ${
								activeButton === "btonBantuan" ? "active" : ""
							}`}
							onClick={() => handleButtonClick("btonBantuan")}
							href="#">
							Bantuan
						</a>
					</li>
					<li className="mx-4">
						<a
							id="btonTentang"
							className={`bton ${
								activeButton === "btonTentang" ? "active" : ""
							}`}
							onClick={() => handleButtonClick("btonTentang")}
							href="#">
							Tentang Kami
						</a>
					</li>
					...
					{isLoggedIn ? null : (
						<>
							<div className="flex gap-4">
								...
								<Link to="/signup">
									<button className="px-4 py-2 text-blue-500 border border-blue-500 rounded-md hover:text-white hover:bg-blue-500">
										Sign up
									</button>
								</Link>
							</div>
