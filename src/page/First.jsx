...
const First = () => {
	...
	return (
		<>
			<div className="-z-20 fixed flex h-screen w-1/2 bg-fixed bg-[url('https://images5.alphacoders.com/349/349822.jpg')]">
			...
			<ul className="z-10 mt-40 flex flex-col justify-center items-center object-center gap-10">
				<li
					id="btnKamar"
